...
public class Testurl {
    ...
    public  void  action (){
        try {
            String url = "http://localhost:8664/"+"getMumber"+"?schemeId=1";
    ...
    public  void  action1 (){
        try {
            String url = "http://localhost:8664/"+"getSchemeList";
    ...
    public  void  action2 (){
        try {
            String url = "http://localhost:8664/"+"getSchemeMessage"+"?schemeId=1";
...
sb.append("{\"schemeId\":1,\"schemeName\":\"test\",\"beginTime\":\"2017-10-19T17:59:03.053488+08:00\",\"endTime\":\"2017-10-19T17:59:34.3375653+08:00\",\"schemeAuthor\":\"test\",\"schemeFile\":\"\",\"schemeDesc\":null,\"sponserId\":10}");
    ...
    public  void  action3 (){
        try {
            String url = "http://localhost:8664/"+"getDate"+"?atrr="+  URLEncoder.encode("{\"SchemeId\":1,\"MumberId\":1,\"AttributeId\":1,\"StartUp\":1,\"EndUp\":5,\"RunTime\":1}","utf-8");
